...
return [
    ...
    'stable_relay' => [
        ...
        'segment_seconds' => (int) env('STABLE_RELAY_SEGMENT_SECONDS', 3),
        'list_size' => (int) env('STABLE_RELAY_LIST_SIZE', 9),
        'delete_threshold' => (int) env('STABLE_RELAY_DELETE_THRESHOLD', 6),
        'ready_segments' => (int) env('STABLE_RELAY_READY_SEGMENTS', 3),
        'stall_seconds' => (int) env('STABLE_RELAY_STALL_SECONDS', 15),
        'startup_timeout_seconds' => (int) env('STABLE_RELAY_STARTUP_TIMEOUT_SECONDS', 20),
        'restart_cooldown_seconds' => (int) env('STABLE_RELAY_RESTART_COOLDOWN_SECONDS', 45),
    ],
    'iptv' => [
